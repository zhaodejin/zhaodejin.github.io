  ...
  <header class="navbar navbar-static-top bs-docs-nav" id="top" role="banner">
      <div class="container">
        <div class="navbar-header">
          ...
          <a href="/#!/index" class="navbar-brand c-blue logo"><img src="../../static/img/logo.png" alt="网站logo"></a>
        </div>
        <nav id="bs-navbar" class="navbar-collapse collapse" aria-expanded="false">
          <ul class="nav navbar-nav">
            ...
            <li>
              <a href="https://www.wondercv.com/cvs/hzXcJtQ/editor">简历</a>
            </li>
            <li>
              <a href="https://element.eleme.cn/2.0/#/zh-CN/component/installation">组件</a>
            </li>
            <li>
              <a href="/#!/works">作品</a>
            </li>
