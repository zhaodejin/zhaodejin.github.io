		...
		<div class="col-md-3 hidden-sm hidden-xs">
			<div class="index-right">
				<div class="author-info bg-white">
					<img src="../../static/img/005.jpg" alt="作者头像" class="img-author">
					<div class="author-name">曹勇<img src="../../static/img/blog/weibo.png" alt="微博图片"></div>
					<div class="author-intro">一个热衷于算法的python后端攻城狮。</div>
					<div class="author-blog">个人站点：<a href="https://github.com/saycmily" target="_blank">https://github.com/saycmily</a></div>
				</div>
